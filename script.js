const games = [
     ...
     { id: "openmw", title: "OpenMW", description: "Recriação de código aberto da engine de The Elder Scrolls III: Morrowind. Permite jogar o jogo original em sistemas modernos com melhorias e suporte a mods aprimorado (requer os dados originais do jogo).", imageUrl: "https://modding-openmw.com/images/steamdeck-openmw-totaloverhaul.jpg", linkUrl: "https://openmw.org/", platforms: ["windows", "mac_os", "linux", "android"], genres: ["Engine", "RPG", "Mundo Aberto", "Recriação", "Modding"], featured: false },
